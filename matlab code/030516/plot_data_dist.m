...
% Plots the num_sets sets of data and results in data using the given
% titles. dim is used to specify how things should be plotted in certain
% sections of the following code. 
